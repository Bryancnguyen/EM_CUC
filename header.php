...
<head>
  ...
  <meta charset="utf-8">
  <title>EllieMae CUC</title>
  <meta name="keywords" content="HTML5 Bootstrap 3 Admin Template UI Theme" />
  <meta name="description" content="Ellie Mae CUC Website">
  <meta name="author" content="Bryan Nguyen">
    ...
    <header class="navbar navbar-fixed-top">
      <div class="navbar-branding">
        <a class="navbar-brand" href="<?php bloginfo('wpurl');?>">
          <b>Ellie</b>Mae <b>CUC</b>
        </a>
        <span id="toggle_sidemenu_l" class="ad ad-lines"></span>
      </div>
      <?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_class' => 'nav nav-tabs', 'menu_id' => 'primary-menu' ) ); ?>
